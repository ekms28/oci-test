...
###Very Importante: I created this text based on OCI, but is not an impeditive to use for AWS, only adapt to the services names and some configurations are diferents during de process, but the idea is the same.
